...
def results(users_id, to_search, number_of_recommendations, selected_genre, selected_type, method, *recommender):
    ...
    if result is not None: 
        ...
        st.write("Sorry, there is no match for this, try again with different filters.")
