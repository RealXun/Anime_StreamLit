...
with st.sidebar:
    choose = option_menu("Anime Recommendator System", ["About this project","What is anime?","Exploring data","Recommmend ased on ratings", "Recommmend Based on Features", "Recommmend Using user ID","EDA", "Anime Info","About the Creator"],
